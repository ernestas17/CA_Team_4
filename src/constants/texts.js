    ...
    servicesSection: {
      services: {
        ...
        service1: {
          ...
          text: 'Through True Ritch Attended does no end it his mother since real had half every him.',
        },
        service2: {
      ...
      form: {
        title: 'Get a quote for the car service',
        paceholder: 'Enter your location',
        button: {
          text: 'Get your quote',
          link: '#',
        },
